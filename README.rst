...
Talk about parallel programming in python.
...
* Strongly based on `previous materials by Eilif Muller and Bastian Venthur
  <https://python.g-node.org/python-summerschool-2012/parallel>`_
